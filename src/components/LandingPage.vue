  ...
  <div class="landingpage">
    ...
    <div class="landing-content">
      <div class="landing-left">
        <img
          class="contentimage"
          src="../assets/images/pexels-teddy-2263436.jpg"
          alt="Sorry...."
        />
        ...
        <p class="landing-subtitle">
          "Music is the heartbeat of the soul – it connects us, inspires
          us, and makes every moment magical. <br />Dive into the rhythm, feel
          the melody, <br />and let the world of music bring joy to your life!"
          🎵💖
        </p>
      </div>
      <hr />
      <div class="sign-up">
        ...
        <form @submit.prevent="handleSignUp">
          ...
          <div class="input-group">
            ...
            />
            <small
              v-for="(error, index) in v$.form.nickname.$errors"
              :key="index"
              >{{ error.$message }}</small
            >
          </div>
...
const handleSignUp = async () => {
  ...
  toast.add({
    ...
    detail: `Account created for ${form.name}`,
    life: 3000,
  });
